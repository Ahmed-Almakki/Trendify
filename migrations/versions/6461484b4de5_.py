...
Revision ID: 6461484b4de5
Revises: 16ecf5e03263
Create Date: 2025-02-26 01:34:30.631258
...
revision = '6461484b4de5'
down_revision = '16ecf5e03263'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        ...
        batch_op.alter_column('user', 'role', new_column_name='roles')
